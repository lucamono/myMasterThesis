...
framework for grasp analysis, simulation and synthesis by opening up interesting scenarios for future works. In \cite{hybrid_approach}, the autors proposed a control scheme as the fusion of the sensor 
