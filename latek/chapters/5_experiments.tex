...
\begin{table*}[ht!]
	...
	\resizebox{0.7\textwidth}{!}{
	 ...
	 \caption{\textbf{The 4 highest confidence score points on not agnostic set.} The accuracy of the network has been tested on a set of 100 test images. The set contains only not agnostic objects w.r.t. the 
	 network.}
...
\begin{table*}[ht!]
	...
	\resizebox{0.7\textwidth}{!}{
	 ...
	 \caption{\textbf{The 4 highest confidence score points on agnostic set.} The accuracy of the network has been tested on a set of 100 test images. The set contains only agnostic objects w.r.t. the 
	 network.}
