...
\begin{figure}[H]
    ...
    junctions called synapses send signals to other neurons. Taken from https://www.khanacademy.org/science/biology/human-biology/neuron-nervous-system/a/overview-of-neuron-structure-and-function} 
    \label{fig:synapse}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{\textbf{CUDA.} Parallel computing platform and programming model developed by NVIDIA for general computing on graphical processing units (GPUs). Taken from https://www.phoronix.com/} 
    \label{fig:cuda_vga}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{\textbf{YOLO output results.} the prediction of YOLO on sample artwork and natural images from the internet. Courtesy of \cite{yolo_paper}} 
    \label{fig:yolo_output}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/2_deep_learning_and_grasping/yolo_architecture}
    \caption{\textbf{YOLO architecture. Courtesy of \cite{yolo_paper}}} 
    \label{fig:yolo_arc}
\end{figure}
