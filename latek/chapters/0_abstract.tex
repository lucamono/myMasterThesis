...
independently, and the choice of the best grasping pose. Given a CAD model, typical approaches are based on estimating the pose of the object by matching its model. Hence, the grasping pose is chosen according to the position and orientation in which the object has been located. We are facing with a clear problem of computer vision, a fundamental element to allow the robot to identify the region in the space where the gripper will perform the grasping.\\
...
\emph{RoCoCo} laboratory at \emph{Sapienza}, University of Rome, this thesis aims to solve the grasping problem of unknown objects by employing a supervised, data driven learning approach. 
