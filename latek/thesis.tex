...
\title{Learning to grasp unknown objects with a robotic arm from experience}

\author{Luca Monorchio}
\email{monorchio.1650427@studenti.uniroma1.it}
...
\newpage
\input{chapters/1_robot_grasping_with_antropomorphic_robots}
\newpage
\input{chapters/2_deep_learning_and_grasping}
\newpage
\input{chapters/3_the_proposed_method}
\newpage
\input{chapters/4_custom_built_dataset}
\newpage
